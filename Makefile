...
update-smartspreader-api:
	...
	docker run --rm -v "$$PWD:$$PWD" -w="$$PWD" mikefarah/yq:4 -i '.images.api |= "scaleaqcontainerregistry.azurecr.io/smartspreader-api:$(tag)"' smartspreader.yaml
update-smartspreader-front-end:
	...
	docker run --rm -v "$$PWD:$$PWD" -w="$$PWD" mikefarah/yq:4 -i '.images.front-end |= "scaleaqcontainerregistry.azurecr.io/smartspreader-front-end:$(tag)"' smartspreader.yaml
